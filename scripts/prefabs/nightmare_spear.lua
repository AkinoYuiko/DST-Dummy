...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_nightmare_spear", "swap_spear")
...
local function fn()
    ...
    inst.AnimState:SetBuild("swap_nightmare_spear")
    ...
    local swap_data = {sym_build = "swap_nightmare_spear", sym_name = "swap_spear", bank = "spear"}
